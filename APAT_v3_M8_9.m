classdef APAT_v3_M8_9 < matlab.apps.AppBase
...
%ISSUE: nothing happens after selecting a file (it doesn't load! It doesn't even show the selected file in the Path Input Field)
