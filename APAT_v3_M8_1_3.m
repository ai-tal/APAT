classdef APAT_v3_M8_1_3 < matlab.apps.AppBase
...
% Error: "Index exceeds array bounds"
    ...
    methods (Access = private)
        ...
        function update(app, scope, arg)
            ...
            switch scope                % scope REWRITES come first: the predicate below binds SCOPE by value (M8.1)
                case "browse"
                ...
                case "export"
                    app.exportMain(arg); return
            end
            is = @(varargin) any(scope == string(varargin));   % anonymous functions copy SCOPE here, not at call time
    ...
    methods (Static)
        function ok = selfTest()
            ...
            K = APAT_v3_M8_1_3.Const; A6 = APAT_v3_M8_1_3.Axes6;
